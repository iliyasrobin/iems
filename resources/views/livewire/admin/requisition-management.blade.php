<div>
    ...
    <!-- JavaScript for requisition details modal - this would be created separately in a normal implementation -->
    <script>
        function showDetails(id) {
            // This would normally open a modal with the requisition details
            alert('Show details for requisition #' + id + '\n\nIn a real implementation, this would open a modal with the full details of the requisition.');
        }
    </script>
</div>